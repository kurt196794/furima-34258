...
ActiveRecord::Schema.define(version: 2021_05_29_192527) do
  ...
  create_table "addresses", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["sold_id"], name: "index_addresses_on_sold_id"
  end
  ...
  add_foreign_key "addresses", "solds"
